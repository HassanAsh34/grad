...
//		//public async Task<ResultDTO> ViewSubjectsAsync(Guid? Tid, List<Guid> ?guids, int disability = -1, Dictionary<Guid,Enrollement> ?enrollements = null, CancellationToken cancellationToken = default)
//		//{
...
//		//	else if (guids != null)
//		//	{
//		//		if (enrollements != null && enrollements.Count > 0)
//		//		{
...
//		//		{
//		//			//float progress = s.LessonCount != 0 ? (enrollements == null || enrollements?.Count == 0 ? 0 : enrollements[s.Id].studentProgresses.Count / s.LessonCount) : 0;
//		//			float progress = 0f;
...
//		//			{
//		//				progress = (enrollment.Progress / s.LessonCount) * 100;
//		//			}
...
//		//		result = subjectDTOs.Count > 0 ? subjectDTOs : null
//		//	};
//		//}
...
//			// BUG FIX: was || (skipped loop when subjects was valid non-empty list)
//			// Also removed redundant null/empty guard — foreach handles it naturally
//			bool hasEnrollements = enrollements is { Count: > 0 };
//			var subjectDTOs = new List<SubjectDTO>(subjects.Count); // pre-size to avoid resizing
...
//					enrollements!.TryGetValue(s.Id, out var enrollment))
//				{
//					progress = (enrollment.Progress / (float)s.LessonCount) * 100f;
//				}
...
//			bool hasResults = subjectDTOs.Count > 0; // evaluate once, use twice
//			return new ResultDTO
//			{
