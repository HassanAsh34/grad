...
namespace  Grad.Infrastructure.Persistence
{
	public class Db_Context : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Submission>().HasOne(s => s.Subject).WithMany(s => s.Submissions).HasForeignKey(s => s.SubjectFK).OnDelete(DeleteBehavior.Cascade);
			...
			modelBuilder.Entity<User>().HasMany(u=>u.Inqueries).WithOne(i=>i.Submitted_By).HasForeignKey(i=>i.submitterId).OnDelete(DeleteBehavior.Cascade);
		}
	}
}
